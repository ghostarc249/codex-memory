...
This repository publishes the `codexmem` package with PyPI Trusted Publishing
through GitHub Actions. Maintainers can publish a release by pushing a signed
version tag:
...
The trusted publisher should be configured on PyPI with:
